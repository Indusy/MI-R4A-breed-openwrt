...
sed -i 's/OpenWrt /编译时间 $(TZ=UTC-8 date "+%Y.%m.%d") @ Indusy /g' package/lean/default-settings/files/zzz-default-settings
...
sed -i 's/ssid=OpenWrt/ssid=Xiaomi_67B5/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh
